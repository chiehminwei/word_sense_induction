...
if __name__ == '__main__':
    ...
    src = os.path.join(os.path.dirname(__file__), 'ecdict.csv')
    dst = os.path.join(os.path.dirname(__file__), 'ecdict.db')
    convert_dict(dst, src)
    
    # lemma = LemmaDB()
    # lemma.load('lemma.en.txt')
    # print(lemma.word_stem('is'))
    # print(lemma.word_stem('caught'))
    ...
    # sentence = "Luna loves me very much so I want to cuddle with her fervently."
    # words = sentence.split(' ')

    # cache = {}
    # candidates = {} # (sense1, sense2) -> count
    # for i in range(len(words)):
    #     for j in range(i+1, len(words)):
    #         word1 = words[i]
    #         word2 = words[j]
    #         if word1 not in cache:
    #             word1_translations = get_translations(sd, word1)
    #             cache[word1] = word1_translations            
    #         if word2 not in cache:
    #             word2_translations = get_translations(sd, word2)
    #             cache[word2] = word2_translations

    #         word1_translations = cache[word1]
    #         word2_translations = cache[word2]

    #         for word1_translation in word1_translations:
    #             for word2_translation in word2_translations:
    #                 # Look up count in FB
    #                 count = FB(word1_translation, word2_translation)
    #                 # Update candidates
    #                 candidates[(word1_translation, word2_translation)] = count
    # candidates.sort()

    # Our algorithm for Word Sense Induction:
    # 1. Get FB map of "cold" from FB_en
    # 2. For each word in sentence, check FB_en[cold], and return the word `ww` with strongest degree (most frequent word_pair)
    ...
    #         if word == target_word:
    #             continue
    #         freq = FB_en(word, target_word)
    #         if freq > max_freq:
    #             max_freq = freq
    #             max_pair = (word, target_word)
    #     word1, word2 = max_pair
    ...
    #         for word2_translation in word2_translations:
    #             # Look up count in FB
    #             freq = FB_zh(word1_translation, word2_translation)
    #             # Update candidates
    #             if freq > max_freq:
    #                 max_freq = freq
    #                 max_pair = (word1_translation, word2_translation)
    #     word1_translation, word2_translation = max_pair
    #     label = word2_translation # Should be 感冒 for "I caught a cold"

        
    # def get_translations(word, sd):
    #     translations = []
    #     query = sd.query('family')
    #     translation = query['translation']
    #     synsets = translation.split('\n')

    #     for synset in synsets:
    #         # Get rid of a., v., n., adv.
    #         # Get rid of []
    #         # Split the remaining by ,
    #     return translations

    # query2 = sd.query('therapy')

    # print(query['translation'])
    # print(query2['translation'])
